...
export type ResolversTypes = {
	...
	UploadItem: ResolverTypeWrapper<Scalars['UploadItem']>;
...
> = {
	...
	>;
	getUploadItem?: Resolver<
		Maybe<ResolversTypes['UploadItem']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetUploadItemArgs, 'id'>
	>;
	getUploadItems?: Resolver<
		Array<ResolversTypes['UploadItem']>,
		ParentType,
		ContextType,
		Partial<QueryGetUploadItemsArgs>
	>;
...
export interface UploadItemScalarConfig
	extends GraphQLScalarTypeConfig<ResolversTypes['UploadItem'], any> {
	name: 'UploadItem';
}
